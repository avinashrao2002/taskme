      ...
      <>
        ...
        <div className="App" onLoad={this.showTasks}>
          <div style={{ marginLeft: "5em" }}>
            <textarea id="newTask" placeholder="Enter a task" value={this.state.taskName} onChange={this.handleChange} className="form-control" style={{ maxWidth: "50em", fontSize: "1em" }}></textarea>
